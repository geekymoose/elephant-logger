...
#include "elephantlogger/outputs/LogOutput_ConsoleColor.h"
 ...
 * This creates a LogOutput_ConsoleColor linked with the default category.
 *
...
{
    static LogOutput_ConsoleColor console;
 ...
 */
inline void
log(LogLevel level, LogCategory category, const char* file, int line, const char* function, const char* format, ...)
{
    ELEPHANTLOGGER_ASSERT(isCategoryValid(category));
...
#define _LOG(level, categoryID, format, ...)                                                                           \
    elephantlogger::log(level, categoryID, __FILE__, __LINE__, __FUNCTION__, format, ##__VA_ARGS__)

#define LOG_WTF(format, ...)                                                                                           \
    _LOG(elephantlogger::LogLevel::Debug,                                                                              \
         elephantlogger::LOG_CATEGORY_DEFAULT,                                                                         \
         __FILE__,                                                                                                     \
         __LINE__,                                                                                                     \
         __FUNCTION__,                                                                                                 \
         format,                                                                                                       \
...
#define LOG_ERROR(format, ...)                                                                                         \
    _LOG(elephantlogger::LogLevel::Error, elephantlogger::LOG_CATEGORY_DEFAULT, format, ##__VA_ARGS__)
#define LOG_WARNING(format, ...)                                                                                       \
    _LOG(elephantlogger::LogLevel::Warning, elephantlogger::LOG_CATEGORY_DEFAULT, format, ##__VA_ARGS__)
#define LOG_CONFIG(format, ...)                                                                                        \
    _LOG(elephantlogger::LogLevel::Config, elephantlogger::LOG_CATEGORY_DEFAULT, format, ##__VA_ARGS__)
#define LOG_INFO(format, ...)                                                                                          \
    _LOG(elephantlogger::LogLevel::Info, elephantlogger::LOG_CATEGORY_DEFAULT, format, ##__VA_ARGS__)
#define LOG_TRACE(format, ...)                                                                                         \
    _LOG(elephantlogger::LogLevel::Trace, elephantlogger::LOG_CATEGORY_DEFAULT, format, ##__VA_ARGS__)
#define LOG_DEBUG(format, ...)                                                                                         \
    _LOG(elephantlogger::LogLevel::Debug, elephantlogger::LOG_CATEGORY_DEFAULT, format, ##__VA_ARGS__)
...
#define LOG_WARNING_IN(categoryID, format, ...)                                                                        \
    _LOG(elephantlogger::LogLevel::Warning, categoryID, format, ##__VA_ARGS__)
